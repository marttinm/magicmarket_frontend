    ...
    <div className="container py-10">
      <div className="max-w-2xl mx-auto space-y-8">
        <div className="text-center space-y-4">
          ...
          <h1 className="text-2xl font-bold">¡Compra en proceso!</h1>
          <p className="text-muted-foreground">
            Gracias por tu compra. Luego de verificar la transferencia se realizará el envío del item. Recuerda que la
            reserva del item será de 12 hs.
          </p>
        </div>
